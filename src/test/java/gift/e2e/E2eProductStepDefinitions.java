...
public class E2eProductStepDefinitions {
    ...
    @Given("{string} 카테고리에 {int}원짜리 {string} 상품이 존재한다")
    ...
    @When("{string} 카테고리에 {int}원짜리 {string} 상품을 생성하면")
    ...
    @Then("각 상품에 가격, 이미지, 카테고리 정보가 포함되어 있다")
